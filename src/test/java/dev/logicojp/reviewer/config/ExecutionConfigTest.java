...
class ExecutionConfigTest {
    ...
    class DefaultValues {
        ...
        void parallelismZeroDefaultsToFour() {
            ExecutionConfig config = new ExecutionConfig(0, 10, 5, 5, 5, 5, 10, 2);
        ...
        void parallelismNegativeDefaultsToFour() {
            ExecutionConfig config = new ExecutionConfig(-1, 10, 5, 5, 5, 5, 10, 2);
            assertThat(config.parallelism()).isEqualTo(4);
        }
        ...
        void orchestratorTimeoutZeroDefaultsToTen() {
            ExecutionConfig config = new ExecutionConfig(4, 0, 5, 5, 5, 5, 10, 2);
        ...
        void orchestratorTimeoutNegativeDefaultsToTen() {
            ExecutionConfig config = new ExecutionConfig(4, -5, 5, 5, 5, 5, 10, 2);
            assertThat(config.orchestratorTimeoutMinutes()).isEqualTo(10);
        }
        ...
        void agentTimeoutZeroDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 0, 5, 5, 5, 10, 2);
        ...
        void agentTimeoutNegativeDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, -3, 5, 5, 5, 10, 2);
            assertThat(config.agentTimeoutMinutes()).isEqualTo(5);
        }
        ...
        void idleTimeoutZeroDefaultsToDefault() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 0, 5, 5, 10, 2);
        ...
        void idleTimeoutNegativeDefaultsToDefault() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, -3, 5, 5, 10, 2);
            assertThat(config.idleTimeoutMinutes()).isEqualTo(ExecutionConfig.DEFAULT_IDLE_TIMEOUT_MINUTES);
        }
        ...
        void skillTimeoutZeroDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 0, 5, 10, 2);
        ...
        void skillTimeoutNegativeDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, -2, 5, 10, 2);
            assertThat(config.skillTimeoutMinutes()).isEqualTo(5);
        }
        ...
        void summaryTimeoutZeroDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, 0, 10, 2);
        ...
        void summaryTimeoutNegativeDefaultsToFive() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, -1, 10, 2);
            assertThat(config.summaryTimeoutMinutes()).isEqualTo(5);
        }
        ...
        void ghAuthTimeoutZeroDefaultsToTen() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, 5, 0, 2);
        ...
        void ghAuthTimeoutNegativeDefaultsToTen() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, 5, -3, 2);
            assertThat(config.ghAuthTimeoutSeconds()).isEqualTo(10);
        }
        ...
        void maxRetriesNegativeDefaultsToDefault() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, 5, 10, -1);
    ...
    class ValidValues {
        ...
        void positiveValuesArePreserved() {
            ExecutionConfig config = new ExecutionConfig(8, 20, 15, 5, 10, 12, 30, 3);
        ...
        void timeoutOneIsPreserved() {
            ExecutionConfig config = new ExecutionConfig(4, 1, 1, 1, 1, 1, 1, 2);
        ...
        void largeValuesArePreserved() {
            ExecutionConfig config = new ExecutionConfig(100, 1000, 500, 50, 300, 200, 600, 10);
        ...
        void maxRetriesZeroIsPreserved() {
            ExecutionConfig config = new ExecutionConfig(4, 10, 5, 5, 5, 5, 10, 0);
    ...
    class RecordEquality {
        ...
        void sameValuesAreEqual() {
            ExecutionConfig config1 = new ExecutionConfig(4, 10, 5, 5, 5, 5, 10, 2);
            ExecutionConfig config2 = new ExecutionConfig(4, 10, 5, 5, 5, 5, 10, 2);
        ...
        void differentValuesAreNotEqual() {
            ExecutionConfig config1 = new ExecutionConfig(4, 10, 5, 5, 5, 5, 10, 2);
            ExecutionConfig config2 = new ExecutionConfig(8, 10, 5, 5, 5, 5, 10, 2);
