...
- 2026-02-24 update (PR #37): local file orchestration was fully split (`LocalFileCollectionCoordinator`/`LocalFileReader`), retry flows were unified across key services, and regression coverage was expanded.
